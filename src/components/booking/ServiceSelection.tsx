...
const jakeServices = [
  ...
  { id: 'j5', name: 'Highlights and Tone with Hair Mask Treatment', price: 3000, duration: 120, description: 'Complete highlighting service with treatment', isStartingPrice: true },
  { id: 'j6', name: 'Balayage & Tone with Hair Mask Treatment', price: 3500, duration: 150, description: 'Balayage coloring with treatment', isStartingPrice: true },
  { id: 'j7', name: 'Keratin & Brazilian with Hair Color and Hair Mask', price: 3000, duration: 180, description: 'Keratin or Brazilian treatment with color', isStartingPrice: true },
  { id: 'j8', name: 'Keratin with Hair Color and Hair Mask', price: 3500, duration: 180, description: 'Keratin treatment with color and mask', isStartingPrice: true },
  { id: 'j9', name: 'Brazilian Blow Out Original with Hair Color and Hair Mask', price: 4000, duration: 180, description: 'Original Brazilian blowout with color', isStartingPrice: true },
  { id: 'j10', name: 'One Step Rebond with Hair Color and Hair Mask', price: 2500, duration: 150, description: 'Quick rebonding with color and treatment', isStartingPrice: true },
];
...
const ServiceSelection = ({ bookingData, setBookingData, onNext }: ServiceSelectionProps) => {
  const services = bookingData.barber?.name === 'Jake' ? jakeServices : mariconServices;
